...
def create_group(object):
	...
	#Request
	request = urllib2.Request(uto+'/api/3/action/group_create')
	...
	try:
		response = urllib2.urlopen(request,data_string)
        	...
        	print "An error occurred while creating a new group"
        	print e.code
        	print e.read()
        	sys.exit(1)
	...
	print "Group created in "+uto



def create_package(string,object):
	...
	#Request
	request = urllib2.Request(uto+'/api/3/action/package_create')
	...
	try:
		...
		print "An error occurred while creating a new package (dataset)"
        	print e.code
        	print e.read()
        	sys.exit(1)
...
def main():
	...
	print "Retrieve Trentino id"
        ...
        #Add all group
        print "Retrieve and create new group"
        for g in grouplist:
		print "-----------------------------------------------------"
		print "Group: "+g
		found = isGroupExist(g)
		if not found:
			print "Group not found, then start to create..."
        ...
        #Add dataset
        print "Retrieve and create new dataset"
        for p in datalist:
		print "-----------------------------------------------------"
		print "Package: "+p
		found = isPackageExist(p)
		if not found:
			print "Package not found, then start to create..."
                	datasetdata = retrieveDataset(p)
                	create_package(orgId,datasetdata)
            	else:
